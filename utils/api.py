...
class APIHandler:
    ...
    def _request_response(self, url: str) -> str:
        ...
        self._log.fatal(f"Unexpected response from server: {response.status_code} {response.reason}")
